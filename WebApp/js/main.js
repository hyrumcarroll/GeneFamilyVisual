...
if(!graph_data.family_list[0].color) {
  ...
  // +1 is a hack because the last two colors generated by create_random_colors() are very similar (and with +1, we don't use the very last one
  var colors = create_random_colors(family_count + 1);
